...
function mayoriaDeEdad(edad){
    if(edad>18) {
        console.log("Felicidades! Ya tienes edad para votar")
    } else {
        console.log("Lo siento, tendras que esperar un poco mas para votar")
    }
}
...
function promediosAlumnos(cal) {
    if(cal>= 7) {
        console.log("Felicidades usted aprobo")
    } else {
        console.log("Lo siento, reprobaste, sigue esforzandote!")
    }
}

//promediosAlumnos(cal);
